...
export const defaultData = {
  ...
  songs: [
    { title: 'We\'re the Lucky Ones', artist: 'The Marías', link: '' },
    { title: 'So Easy (To Fall In Love)', artist: 'Olivia Dean', link: '' },
    { title: 'santa doesn\'t know you like i do', artist: 'Sabrina Carpenter', link: '' },
    { title: 'White Christmas', artist: 'Jeff Bernat', link: '' },
    { title: 'Dancing in the Dark', artist: 'Rihanna', link: '' },
    { title: 'Candy Cane Lane', artist: 'Sia', link: '' },
    { title: 'Kiss You This Christmas', artist: 'Why Don\'t We', link: '' },
  ],
};
